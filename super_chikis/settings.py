"""
Django settings for super_chikis project.
...
# Si estamos en Railway, usamos el volumen montado
if os.getenv('RAILWAY_VOLUME_MOUNT_PATH'):
    DB_PATH = os.path.join(os.getenv('RAILWAY_VOLUME_MOUNT_PATH'), 'db.sqlite3')
else:
...
# Configuración para imágenes y archivos subidos por el usuario
MEDIA_URL = '/media/'
